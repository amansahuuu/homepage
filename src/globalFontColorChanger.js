                    ...
                    <div class="space-y-5">
                        ...
                        <div class="space-y-3">
                            <div class="flex flex-wrap gap-2">
                                ...
                                <button onclick="selectColor('#EEE1C6')" class="color-preset w-8 h-8 bg-white rounded-sm border-2 border-gray-300 hover:border-blue-500 transition-colors" title="white"></button>
                            </div>
